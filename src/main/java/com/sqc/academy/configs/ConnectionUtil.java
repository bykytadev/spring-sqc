package com.sqc.academy.configs;
...
public class ConnectionUtil {
    // Đối tượng sessionFactory được sử dụng để quản lý phiên làm việc (Session)
    // trong Hibernate
    public static SessionFactory sessionFactory;

    // Khối khởi tạo tĩnh sẽ được thực hiện khi lớp ConnectionUtil được nạp vào bộ
    // nhớ
    static {
        try {
